...
Fixed: wraplength adjusted for wider panel, status bar spacing improved.
"""
...
class ForkBuildCard(tk.Frame):
    def __init__(self, parent, info, server_mode, **kwargs):
        ...
        InfoRow(self, "Server Mode", server_mode, T.SUCCESS).pack(
            fill='x', padx=T.PADDING_MD, pady=(2, 2))
        # FIX: Increased wraplength from 260 to 380 to match new panel width
...
class SystemStatusBar(tk.Frame):
    def __init__(self, parent, **kwargs):
        ...
        # FIX: Added vertical padding for better readability
        ...
        # FIX: Added separator frames between metrics for visual clarity
    ...
    def update_values(self, temp=0, cpu=0, mem=0, net_up=0, net_down=0, uptime_seconds=0):
        ...
        # FIX: Format uptime as HH:MM:SS for readability
